...
$sql = "UPDATE tbl_questions SET question='$question',topic = '$topic',positive_mark = $pos, negative_mark = $neg, option1='$opt1', option2='$opt2', option3='$opt3', option4='$opt4', answer='$answer', imgs='$image1' WHERE question_id='$question_id'";
}
else{
    $sql = "UPDATE tbl_questions SET question='$question',topic = '$topic',positive_mark = $pos, negative_mark = $neg, option1='$opt1', option2='$opt2', option3='$opt3', option4='$opt4', answer='$answer' WHERE question_id='$question_id'";
}
...
$sql = "UPDATE tbl_questions SET question='$question',topic = '$topic',positive_mark = $pos, negative_mark = $neg, answer='$answer' WHERE question_id='$question_id'";
